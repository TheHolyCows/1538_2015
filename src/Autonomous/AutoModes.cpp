...
{	
	...
	m_Modes["Default"].push_back(RobotCommand(CMD_DRIVE_DISTANCE, 48.5, 0, CONSTANT("VERTICAL_ONE_TOTE")+5, GRAB, CONSTANT("PINCHER_CAN"), -0.2, 0.75));
	m_Modes["Default"].push_back(RobotCommand(CMD_WAIT, 48.5, 0, CONSTANT("VERTICAL_ONE_TOTE")+14, PINCH, 0, 0, 0.35));
